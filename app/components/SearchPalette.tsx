  ...
  return (
    <>
      ...
      >
        ...
        >
          <MagnifyingGlassIcon className="absolute w-7 h-7 top-1/2 transform -translate-y-1/2 left-3 text-slate-700 transition dark:text-white pointer-events-none" />
          <input
            ...
            {searchState.status === "idle" &&
              ...
              (!searchState.results || searchState.results.length === 0) && (
                <div className="results-none flex">
                  <ExclamationTriangleIcon className="h-5 w-5 mr-1 text-white"></ExclamationTriangleIcon>
                  <Body className="text-slate-400">
